...
export default function BarrierDivider({ label }) {
  return (
    <div className="barrier" role="presentation">
      ...
      <div className="barrier__rig">
        <div className="barrier__signals" aria-hidden="true">
          <span className="barrier__light barrier__light--a" />
          <span className="barrier__light barrier__light--b" />
        </div>
